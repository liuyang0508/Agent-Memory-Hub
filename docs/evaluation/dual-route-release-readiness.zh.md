...
当前冻结代码候选 `17696138262b8c807852be5baf3c9cb9eccf7c49` 的校准门禁与
...
`17696138262b8c807852be5baf3c9cb9eccf7c49`。两边使用同一个全新公开合成 brain、
...
|---|---|---:|---:|---:|---:|---:|---:|
| 1 | base hook | 30 | 2885.859ms | 3023.973ms | 3058.796ms | 0 | 0 |
| 1 | candidate hook | 30 | 1267.026ms | 1318.511ms | 1339.789ms | 0 | 0 |
| 2 | base hook | 30 | 2900.373ms | 3038.427ms | 3140.447ms | 0 | 0 |
| 2 | candidate hook | 30 | 1274.442ms | 1308.130ms | 1309.306ms | 0 | 0 |

第一轮 p95 delta 为 -1705.462ms，第二轮为 -1730.297ms。两轮 `passed=true`、
...
`superseded_candidate_confirmation`，最终候选修复后重新执行了上表两轮正式门禁。
