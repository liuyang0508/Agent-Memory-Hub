...
`e65c9e1087f21477821cfd9606cfa8ea2443b500`。两边使用同一个全新公开合成 brain、同一个
...
|---|---:|---:|---:|---:|---:|---:|
| base hook | 30 | 3002.549ms | 3190.560ms | 3241.045ms | 0 | 0 |
| candidate hook | 30 | 1615.757ms | 1736.283ms | 1746.549ms | 0 | 0 |

candidate p95 相对 base 为 -1454.277ms，benchmark exit code 为 0，性能子门禁 PASS。
...
test "$(git -C "$CAND" rev-parse HEAD)" = e65c9e1087f21477821cfd9606cfa8ea2443b500
