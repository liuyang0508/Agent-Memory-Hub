...
`9df44cffbff67b7446667fa0715b14433a2ebb77`。两边使用同一个全新公开合成 brain、同一个
...
|---|---:|---:|---:|---:|---:|---:|
| base hook | 30 | 3011.582ms | 3069.691ms | 3111.099ms | 0 | 0 |
| candidate hook | 30 | 1711.744ms | 1767.039ms | 1810.193ms | 0 | 0 |

candidate p95 相对 base 为 -1302.652ms，benchmark exit code 为 0，性能子门禁 PASS。
...
test "$(git -C "$CAND" rev-parse HEAD)" = 9df44cffbff67b7446667fa0715b14433a2ebb77
