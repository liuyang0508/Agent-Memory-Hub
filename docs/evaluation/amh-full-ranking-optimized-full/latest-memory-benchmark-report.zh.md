...
<p align="center">
  <img src="./amh-memorydata-report-chart.svg" alt="AMH 评测报告快照：论文图下方追加本机复现指标" width="100%">
</p>
...
| longmemeval-qa-judge-full | LongMemEval | B：官方同源但有派生/子集边界 | 500 / 500 judged rows | LongMemEval-S answer generation + LLM-as-judge full；单独发布，不替代 retrieval R@K。 |
...
- 本地结果：LongMemEval-S 500-case R@K full and QA/Judge full completed.
...
| answer generation | done | 必须保存逐题 output 的 generation *_results.json。 |
| LLM-as-judge | done | 必须保存 sidecar judge JSON，且 judged_rows 覆盖 supported_rows。 |
| report publish | qa-judge-published | generation 与 judge 分数单独发布，不替代 retrieval R@K。 |

| 项 | 状态 | 样本 | 指标 | 产物 |
| --- | --- | --- | --- | --- |
| Generation | passed | 500 | Exact EM=7.40; Substring EM=27.00; F1=20.59; ROUGE-L F1=19.87; ROUGE-L Recall=35.28 | docs/evaluation/amh-full-ranking-optimized-full/longmemeval-generation-full-results.json |
| Judge | passed | 500 / 500 | Judge Accuracy=41.60% | docs/evaluation/amh-full-ranking-optimized-full/longmemeval-generation-full.longmemeval_judge.json |
...
| 维度 | 状态 | 样本行数 | 关键指标 | 产物 |
| --- | --- | --- | --- | --- |
| 准确召回 AR | passed | 500 / 500 | EM 48.00%; F1 67.30%; EventQA Recall 48.20% | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full/memoryagentbench-ar-eventqa/outputs/gui-owl-amh/Accurate_Retrieval/eventqa_full_unknown_in800000_size40_shots0_max_samples5_variantbm25-rrf_results.json |
| 测试时学习 TTL | passed | 100 / 100 | EM 60.00%; Label Accuracy 60.00%; Label Format 100.00% | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full/memoryagentbench-ttl-icl-banking77/outputs/gui-owl-amh/Test_Time_Learning/icl_banking77_5900shot_balance_unknown_in131072_size20_shots0_max_samples100_variantbm25-rrf_results.json |
| 长程理解 LRU | passed | 71 / 71 | EM 0.00%; F1 11.29%; ROUGE-L Recall 52.99% | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full/memoryagentbench-lru-detectiveqa/outputs/gui-owl-amh/Long_Range_Understanding/detective_qa_unknown_in200000_size2000_shots0_max_samples10_variantbm25-rrf_results.json |
| 冲突解决 CR | passed | 100 / 100 | EM 3.00%; Answer Hit 5.00%; Concise Response 100.00% | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full/memoryagentbench-cr-fact-mh-6k/outputs/gui-owl-amh/Conflict_Resolution/factconsolidation_mh_6k_unknown_in6000_size10_shots0_max_samples1_variantbm25-rrf_results.json |
...
| --- | --- | --- | --- | --- | --- | --- |
| LoCoMo 4cat QA full | LoCoMo | passed | 1540 / 1540 QA | EM 16.04%; F1 36.05%; ROUGE-L F1 35.50%; ROUGE-L Recall 45.70% | LoCoMo official locomo10 derived category 1-4 QA; excludes adversarial/category 5. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/locomo-4cat/outputs/gui-owl-amh/LoCoMo/locomo_qa_4cat_600_dist_in150000_size64_shots0_max_samples10_split_locomo_4cat_600_dist_variantbm25-rrf_results.json |
| LoCoMo category5 adversarial full | LoCoMoCategory5 | passed | 446 / 446 QA | EM 20.85%; F1 38.95%; ROUGE-L F1 38.28%; ROUGE-L Recall 50.87% | LoCoMo official locomo10 category 5 adversarial questions, scored separately against adversarial_answer; not mixed into the category 1-4 QA benchmark. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/locomo-category5-adversarial/outputs/gui-owl-amh/LoCoMo/locomo_qa_category5_adversarial_in150000_size64_shots0_max_samples10_category_adversarial_variantbm25-rrf_results.json |
| LongBench rep150 proportional full | LongBench | passed | 150 / 150 rows | EM 27.33%; F1 20.67%; ROUGE-L F1 20.67%; ROUGE-L Recall 20.67% | MemoryData deterministic 150-row proportional subset; not THUDM LongBench-v2 503-question full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/longbench-rep150/outputs/gui-owl-amh/LongBench/longbench_rep150_proportional_rep150_proportional_in2000000_size32_shots0_max_samples150_variantbm25-rrf_results.json |
| LongBench-v2 503-question full | LongBenchV2Full | passed | 503 / 503 rows | EM 32.21%; F1 23.26%; ROUGE-L F1 23.26%; ROUGE-L Recall 23.26% | Official THUDM LongBench-v2 503-question full set through MemoryData-compatible loader. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/longbench-v2-503/outputs/gui-owl-amh/LongBench/longbench_v2_503_full_v2_503_full_in2000000_size32_shots0_max_samples503_variantbm25-rrf_results.json |
| MemBench simple full | MemBench | passed | 100 / 100 rows | EM 91.00%; F1 63.00% | MemBench public FirstAgent simple slice full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/membench-simple/outputs/gui-owl-amh/MemBench/membench_simple_light_in200000_size8_shots0_max_samples100_variantbm25-rrf_results.json |
| MemBench noisy full | MemBench | passed | 100 / 100 rows | EM 69.00%; F1 51.00% | MemBench public FirstAgent noisy slice full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/membench-noisy/outputs/gui-owl-amh/MemBench/membench_noisy_light_in200000_size8_shots0_max_samples100_variantbm25-rrf_results.json |
| MemBench knowledge_update full | MemBench | passed | 100 / 100 rows | EM 76.00%; F1 61.00% | MemBench public FirstAgent knowledge_update slice full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/membench-knowledge-update/outputs/gui-owl-amh/MemBench/membench_knowledge_update_light_in200000_size8_shots0_max_samples100_variantbm25-rrf_results.json |
| MemBench highlevel full | MemBench | passed | 150 / 150 rows | EM 87.33%; F1 61.33% | MemBench public FirstAgent highlevel slice full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/membench-highlevel/outputs/gui-owl-amh/MemBench/membench_highlevel_light_in200000_size8_shots0_max_samples150_variantbm25-rrf_results.json |
| MemBench RecMultiSession full | MemBench | passed | 50 / 50 rows | EM 46.00%; F1 30.00% | MemBench public FirstAgent RecMultiSession slice full. | docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts/full-family/membench-recmultisession/outputs/gui-owl-amh/MemBench/membench_recmultisession_light_in200000_size8_shots0_max_samples50_variantbm25-rrf_results.json |

## 运行记录

| 名称 | 状态 | 命令 / 原因 | 产物 |
| --- | --- | --- | --- |
| memorydata-smoke | blocked | `python main.py --agent_config config/hybrid_amh.yaml --dataset_config benchmark/memoryagentbench/Accurate_Retrieval/config/EventQA/Eventqa_full.yaml --max_test_queries_ablation 1 --artifact_root docs/evaluation/amh-full-ranking-optimized-full/memorydata-artifacts` | - |
