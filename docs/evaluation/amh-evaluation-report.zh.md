...
**生成时间**：2026-07-02T15:43:39.496891+00:00
**数据来源**：`memory benchmark system`
**结论**：PASS，cases=240，items=1310，top_k=10。
...
| 指标 | Token | 说明 |
| --- | --- | --- |
| 全文详情预算 | 220433 | 如果把命中 item 的详情全部放入上下文，benchmark 记录的 token 预算。 |
| ContextPack 注入 | 53635 | 经过 locator / overview / detail_uri 分层装载后的实际注入预算。 |
| 节省 Token | 166798 | full_tokens - packed_tokens，负数按 0 处理。 |

ContextPack 节省率：**75.67%**；压缩比：**0.243**。
